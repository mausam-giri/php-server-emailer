...
require 'path/to/smtp/src/Exception.php';
require 'path/to/smtp/src/smtp.php';
require 'path/to/smtp/src/SMTP.php';
```
...
```php
<?php
//Import smtp classes into the global namespace
//These must be at the top of your script, not inside a function
use smtp\src\Exception;use smtp\src\PHPMailer;use smtp\src\SMTP;
...
try {
    ...
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = smtp::ENCRYPTION_STARTTLS`
